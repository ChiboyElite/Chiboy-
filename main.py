...
# =============================================================================
#  LOGGING
#  NOTE: explicitly using stdout — Railway (and most log platforms) tag
#  anything on stderr as "error" regardless of the actual log level, which
#  makes every INFO line show up red/Error in the dashboard. Routing to
#  stdout keeps INFO lines looking like INFO and reserves red for logger
#  calls actually made at ERROR level.
# =============================================================================
logging.basicConfig(
    level=logging.INFO,
...
async def main() -> None:
    ...
    # --- TEMPORARY TEST — remove after confirming Telegram delivery ---
    send_telegram("✅ Test message — scanner deployed and Telegram is connected.")
    # -------------------------------------------------------------------
